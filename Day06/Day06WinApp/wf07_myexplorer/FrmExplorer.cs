...
namespace wf07_myexplorer
{
    public partial class FrmExplorer : Form
    {
        ...
        private void FrmExplorer_Load(object sender, EventArgs e)
        {
            ...
            {
                if (drive.DriveType == DriveType.Fixed)     // 실제 존재하는 하드 드라이브만...
                {
        ...
        // sender : 자기자신에 대한 객체 내용 / e : 각 이벤트 관련 속성 포함 매개변수
        ...
        private void TxtPath_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == 13)        // KeyBoard 엔터키를 누르면
            {
                ...
                {
                    MessageBox.Show("경로를 찾을 수 없음. 다시 시도!!!", "나의 탐색기", MessageBoxButtons.OK, MessageBoxIcon.Error);
                } 
